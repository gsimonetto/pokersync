...
export const MODULE_COPY: Record<ModuleKey, ModuleCopy> = {
  ...
  ranges: {
    ...
    blurb: "Monte ranges e veja na hora como eles acertam o board, do pré-flop ao river — no estilo Flopzilla.",
    benefits: [
      "Grade com peso por mão e por naipe, Top % e colar/copiar range",
      "Como o range acerta o flop, o turn e o river",
      "Equidade contra o range do vilão, mão por mão",
      "Todos os flops: onde o range vai bem e onde sofre",
      "Seu range de verdade (das mãos importadas) comparado com o GTO",
      "Ranges do time e treino rápido",
    ],
  },
  marketplace: {
    title: "Vagas",
    ...
    benefits: [
      "Vagas abertas de MTT, Cash, SNG e Spin, em reais ou em dólar",
      "Match explicado: seu número ao lado de cada requisito da vaga",
      "Aviso quando abrir vaga que combina com você",
      "Conversa com o time antes da decisão, candidaturas num só lugar",
