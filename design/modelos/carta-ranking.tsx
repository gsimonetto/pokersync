...
// ============================================================
// MODELO GUARDADO -- não é usado no app (pedido explícito: "guarde esse
// modelo para os rankings, vou usar em outro momento"). A ficha do
// ranking em uso continua em components/hub/ranking/ficha.tsx.
//
// Carta do jogador no ranking, no mesmo nível da carta de Membro
// Fundador. Pra usar: importar `CartaRankingModelo` no lugar de
// `FichaJogador` (mesmas props).
//
...
export function CartaRankingModelo({ j, eu, onFechar }: { j: JogadorRanking; eu: JogadorRanking | null; onFechar: () => void }) {
